...
const JsonImportButton: React.FC = observer(() => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto h-full">
      <label htmlFor="json-upload" className="relative cursor-pointer bg-white dark:bg-gray-800 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-600 flex flex-col justify-center items-center h-full p-6 hover:border-violet-400 dark:hover:border-violet-500 transition-colors duration-300">
