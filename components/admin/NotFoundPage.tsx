    ...
    return (
        <div className="min-h-screen flex items-center justify-center text-center p-4">
            <div>
                ...
                <Link to="/dashboard" className="mt-6 inline-block bg-violet-600 text-white font-semibold px-6 py-3 rounded-full hover:bg-violet-700 transition-colors shadow-lg">
                    Go to Dashboard
                </Link>
            </div>
        </div>
