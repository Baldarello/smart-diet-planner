...
const translations = {
  it: {
    ...
    noIngredientsSuggestion: "La tabella è vuota. Aggiungi ingredienti manualmente o usa il pulsante 🔄 per popolarla con ingredienti comuni.",
  ...
  en: {
    ...
    noIngredientsSuggestion: "The table is empty. Add ingredients manually or use the 🔄 button to populate it with common ingredients.",
