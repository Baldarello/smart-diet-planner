...
const translations = {
  it: {
    ...
    settingsMacrosMode: "Modalità Macronutrienti",
    ...
    deletePlanConfirmationMessage: "Sei sicuro di voler eliminare questo piano? L'azione è irreversibile.",
    createdOn: "Creato il",
    ...
    deleteRecipeConfirmationMessage: "Sei sicuro di voler eliminare questa ricetta? L'azione è irreversibile.",
    ...
    homeFeaturesTitle: "Tutto Ciò di Cui Hai Bisogno, in un Unico Posto",
    homeFeature1Title: "Organizzazione Intelligente",
    homeFeature1Desc: "Importa il tuo piano e LifePulse lo struttura automaticamente in un calendario giornaliero, calcolando i valori nutrizionali per ogni pasto.",
    homeFeature2Title: "Lista della Spesa Automatica",
    homeFeature2Desc: "Non dimenticare mai nulla. Una lista della spesa completa e categorizzata viene generata dal tuo piano settimanale.",
    homeFeature3Title: "Dispensa Intelligente",
    homeFeature3Desc: "Tieni traccia di ciò che hai a casa. Gli articoli vengono scalati man mano che li consumi e quelli in esaurimento tornano nella lista della spesa.",
    homeFeature4Title: "Visualizza i Tuoi Progressi",
    homeFeature4Desc: "Monitora peso, composizione corporea e aderenza alla dieta nel tempo con grafici intuitivi e serie di obiettivi.",
    homeBenefitsTitle: "Come LifePulse Ti Aiuta ad Avere Successo",
    homeBenefit1: "Rimani Costante",
    homeBenefit1Desc: "Checklist giornaliere, promemoria per i pasti e tracciamento dell'idratazione ti aiutano a costruire abitudini sane e a seguire il piano.",
    homeBenefit2: "Fai la Spesa in Modo Intelligente",
    homeBenefit2Desc: "Risparmia tempo e denaro con una lista perfettamente aggregata. Compra solo ciò che ti serve, quando ti serve.",
    homeBenefit3: "Rimani Motivato",
    homeBenefit3Desc: "Guarda i tuoi progressi prendere forma in grafici chiari. Guadagna obiettivi e mantieni le tue 'strisce' positive per non perdere la motivazione.",
    homeFinalCta: "Pronto a prendere il controllo della tua dieta?",
    ...
    shoppingListEmptyTitle: "Dispensa al Top!",
    shoppingListEmptyMessage: "La tua lista della spesa è vuota. Hai tutto il necessario per dare il massimo questa settimana e raggiungere i tuoi obiettivi. Continua così!",
    shoppingListEmptyButton: "Torna alla Dashboard",
    ...
    achievementFirstHydrationDesc: "Registra la tua prima assunzione di acqua.",
    achievementPerfectWeekHydration: "Settimana di Idratazione Perfetta",
    achievementPerfectWeekHydrationDesc: "Raggiungi il tuo obiettivo di idratazione per 7 giorni consecutivi.",
    achievementTotalWater50L: "Bacino Idrico Personale",
    achievementTotalWater50LDesc: "Raggiungi un totale di 50 litri d'acqua bevuti.",
    achievementFirstSteps: "Primo Passo",
    achievementFirstStepsDesc: "Registra i tuoi primi passi nell'app.",
    achievementDailyStepGoalReached: "Obiettivo Raggiunto!",
    achievementDailyStepGoalReachedDesc: "Raggiungi il tuo obiettivo di passi giornaliero per la prima volta.",
    achievementStepMarathon: "Maratoneta dei Passi",
    achievementStepMarathonDesc: "Totalizza 250.000 passi totali.",
    achievementPerfectWeekSteps: "Passo Costante",
    achievementPerfectWeekStepsDesc: "Raggiungi l'obiettivo passi per 7 giorni consecutivi.",
  ...
  en: {
    ...
    noIngredientsSuggestion: "The table is empty. Add ingredients manually or import a file.",
    ...
    homeSubtitle: "Transform your diet plan into an actionable, daily guide. Stay organized, track your progress, and achieve your health goals with ease.",
    homeFeaturesTitle: "Everything You Need in One Place",
    homeFeature1Title: "Intelligent Plan Organization",
    homeFeature1Desc: "Import your diet plan, and LifePulse automatically structures it into a daily schedule, calculating nutritional values for each meal.",
    homeFeature2Title: "Automatic Shopping List",
    homeFeature2Desc: "Never forget an item. A complete, categorized shopping list is generated from your weekly plan.",
    homeFeature3Title: "Smart Pantry",
    homeFeature3Desc: "Track what you have at home. Items are automatically deducted as you consume them, and low-stock items are added back to your list.",
    homeFeature4Title: "Visualize Your Progress",
    homeFeature4Desc: "Monitor your weight, body composition, and adherence over time with insightful charts and streaks.",
    homeBenefitsTitle: "How LifePulse Helps You Succeed",
    homeBenefit1: "Stay Consistent",
    homeBenefit1Desc: "Daily checklists, meal reminders, and hydration tracking help you build healthy habits and stick to your plan.",
    homeBenefit2: "Shop Smarter",
    homeBenefit2Desc: "Save time and money with a perfectly aggregated list. Buy only what you need, when you need it.",
    homeBenefit3: "Stay Motivated",
    homeBenefit3Desc: "Watch your progress unfold in beautiful charts. Earn achievements and maintain streaks to keep your motivation high.",
    homeFinalCta: "Ready to take control of your diet?",
    ...
    shoppingListEmptyTitle: "Pantry is Perfect!",
    shoppingListEmptyMessage: "Your shopping list is empty. You have everything you need to crush your goals this week. Stay consistent and keep it up!",
    shoppingListEmptyButton: "Back to Dashboard",
    ...
    unsavedChangesMessage: "You have unsaved changes. Are you sure you want to switch tabs? Your changes will be lost.",
